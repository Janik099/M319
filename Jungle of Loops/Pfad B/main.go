...
func main() {
	...
	if frequenz == 440.0 && reaktor.LadungsStand < 100 {
		...
		case "DRAGON_WEAKEN":
			fmt.Println("[MODUS]: Lichtsäule wird auf Entropiedrachen ausgerichtet!")
		case "SAFE_MODE":
			fmt.Println("[MODUS]: System im Wartungsmodus. Minimaler Ausstoss.")
		case "SHUTDOWN":
			fmt.Println("[MODUS]: Notabschaltung eingeleitet.")
		default:
			fmt.Println("[WARNUNG]: Unbekannter Code! System instabil.")
		}
		...
		for i := reaktor.LadungsStand; i <= zielLadung; i += 20 {
